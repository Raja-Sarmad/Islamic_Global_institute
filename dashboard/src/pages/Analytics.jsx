...
import { useGetAnalyticsQuery } from '../services/apiSlice';
...
export default function Analytics() {
  const { data: analyticsData, isLoading, isError, error, refetch } = useGetAnalyticsQuery();
  ...
  // Mock data for demonstration since we're focusing on user dashboard
  const mockStats = {
    totalStudents: 1247,
    activeStudents: 892,
    completionRate: '78%',
  ...
  const mockProgressData = [
    { date: '2024-01-01', status: 'present', lesson: 'Introduction', performance: 'excellent' },
    { date: '2024-01-02', status: 'present', lesson: 'Basic Concepts', performance: 'good' },
    { date: '2024-01-03', status: 'absent', lesson: 'Advanced Topics', performance: 'needs_improvement' },
    { date: '2024-01-04', status: 'present', lesson: 'Practice Session', performance: 'excellent' },
    { date: '2024-01-05', status: 'late', lesson: 'Review', performance: 'average' },
    { date: '2024-01-06', status: 'present', lesson: 'Final Assessment', performance: 'good' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-xl font-bold text-gray-900 mb-6">Progress Analysis</h2>
        <AttendanceChart data={mockProgressData} />
      </motion.div>
      ...
      >
        ...
        <div className="space-y-4">
          {mockProgressData.slice(0, 5).map((item, index) => (
            <div
              key={index}
